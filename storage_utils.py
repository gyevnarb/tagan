...
def save_statistics(experiment_log_dir, filename, stats_dict, current_epoch,
    ...
    """
    Saves the statistics in stats dict into a csv file. Using the keys as the header entries and the
        values as the columns of a particular header entry
    ...
    :param current_epoch: the number of epochs since commencement of the current training session
        (i.e. if continued from 100 and this is epoch 105, then pass relative distance of 5.)
